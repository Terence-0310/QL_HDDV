...
- Name: reports.spec.ts >> report/export flow (CSV) >> admin truy cập report hợp đồng và xuất CSV
- Location: tests\e2e\reports.spec.ts:6:7
...
> 6  |   await page.getByLabel("Email").fill(input.email);
  ...
  13 |   await expect(page.getByRole("heading", { name: "Tổng quan" })).toBeVisible({ timeout: 15000 });
  14 | }
  15 | 
